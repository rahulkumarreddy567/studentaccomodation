...
public class PhotoDAO {
    ...
    private static void seedData(Statement s) throws SQLException {
        s.execute("INSERT INTO photos(accommodation_id, image_url, caption, is_primary) VALUES " +
                "(1, 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1000', 'Living Room', 1)");
        s.execute("INSERT INTO photos(accommodation_id, image_url, caption, is_primary) VALUES " +
                "(1, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1000', 'Bedroom', 0)");
        s.execute("INSERT INTO photos(accommodation_id, image_url, caption, is_primary) VALUES " +
                "(9, 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=1000', 'Exterior View', 1)");
        s.execute("INSERT INTO photos(accommodation_id, image_url, caption, is_primary) VALUES " +
                "(9, 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1000', 'Kitchen', 0)");
    }

    public static Photo create(int accommodationId, String imageUrl, String caption, boolean isPrimary)
            throws SQLException {
